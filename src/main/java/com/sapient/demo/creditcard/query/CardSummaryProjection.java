package com.sapient.demo.creditcard.query;
...
public class CardSummaryProjection {
    ...
    public void on(IssuedEvt event) {
         ...
         */
        entityManager.persist(new CardSummary(event.getId(), event.getLimitValue(), event.getLimitValue(), event.getName()));
        /*
    ...
    @EventHandler
    public void on(PurchasedEvt event) {
        log.trace("projecting {}", event);
        /*
        ...
        summary.setRemainingValue(summary.getRemainingValue() - event.getPurchaseValue());
        /*
         * Serve the subscribed queries by emitting an update. This reads as follows:
         ...
         *   in the query's filter
         * - send a message containing the new state of this credit card summary
         */
